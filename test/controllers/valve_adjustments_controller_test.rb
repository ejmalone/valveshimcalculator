...
class ValveAdjustmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create valve_adjustment" do
    assert_difference("ValveAdjustment.count") do
      post engine_valve_adjustments_url(@engine), params: { valve_adjustment: { adjustment_date: @valve_adjustment.adjustment_date, mileage: @valve_adjustment.mileage, notes: @valve_adjustment.notes } }
    end
  ...
  test "should update valve_adjustment" do
    patch engine_valve_adjustment_url(@engine, @valve_adjustment), params: { valve_adjustment: { adjustment_date: @valve_adjustment.adjustment_date, engine_id: @valve_adjustment.engine_id, mileage: @valve_adjustment.mileage, notes: @valve_adjustment.notes } }
